...
export default function ExportMenu({
  onExportPNG, onExportJPEG, onExportPDF, onExportJSON, onClose,
}: {
  onExportPNG: () => void;
  onExportJPEG: () => void;
  onExportPDF: () => void;
  ...
  return (
    <div className="animate-pop-in absolute bottom-24 left-1/2 -translate-x-1/2 z-30 w-48 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 shadow-lg py-1 text-sm">
      <button
