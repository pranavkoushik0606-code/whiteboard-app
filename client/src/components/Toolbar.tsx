...
export default function Toolbar({
  ...
  // A viewer keeps Select — they can still pan, zoom and marquee nothing — plus
  // everything that only reads: grid, comments, history, export. The write
  // controls are removed rather than disabled; a greyed-out row of thirteen
  // shapes is just noise.
